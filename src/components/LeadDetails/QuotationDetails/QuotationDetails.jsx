...
const QuotationDetails = ({ 
 ...
 fontWeight: "bold", fontSize: "12px", color: "#4E5A6B", ml: "5px" }}>
        Quotation Details
      </Typography>
      <Box
        sx={{
      ...
      >
        <Box sx={{ display: "flex", flexDirection: "column", fontSize: "8px" }}>
          <Typography sx={{ fontSize: "10px", color: "gray", marginBottom: "5px",             fontFamily: "Nunito Sans",
 }}>
            Lease Start Date
          </Typography>
        ...
        <Box sx={{ display: "flex", flexDirection: "column", fontSize: "8px" }}>
          ...
          <Typography sx={{ fontSize: "10px",             fontFamily: "Nunito Sans",
 fontWeight: "bold" }}>
            {rentStartDate}
          </Typography>
        </Box>
