...
const MainContent = () => {
  const breadcrumbs = [
    <Link underline="hover" key="1" color="rgba(80,120,225)" href="/" fontFamily={"Nunito Sans,"}  fontSize={"14px"} onClick={handleClick}>
      Add Contact
    </Link>,
    <Link
      underline="hover"
    ...
    <Typography key="3" sx={{ color: 'rgb(80,120,225)' }} fontFamily={"Nunito Sans"} fontSize={"14px"}>
     Preview and create Lead
    </Typography>,
    <Typography key="3" sx={{ color: 'rgb(80,120,225)' }} fontFamily={"Nunito Sans"} fontSize={"14px"}>
    Preview and create Lead
   
   </Typography>,  <Box key="5" sx={{ display: 'flex', alignItems: 'center', color: 'rgb(80,120,225)' }}fontFamily={"Nunito Sans"} fontSize={"14px"}>
  ...
  return (
    <Box  sx={{ height: '78vh', width: '90vw',boxShadow: '0px 4px 4px rgba(0, 0, 0, 0.25)',borderRadius:"5px",            fontFamily: "Nunito Sans",
    }}>
    ...
    <Grid2 container spacing={0} sx={{flexGrow: 1,           
      ...
      <Grid2 size={4} padding={2} sx={{flexGrow: 1,            
        display: 'flex', backgroundColor:"white",flexDirection:"column"}}>
           <Typography padding={1} sx={{color:"#4E5A6B",fontSize:"14px",position:"relative",top:"-16px",fontWeight:"bold"       ,     fontFamily: "Nunito Sans",
}}>Lead Details  </Typography>
      <LeadDetails />
      <QuotationDetails  sx={{            fontFamily: "Nunito Sans",
      ...
      <Grid2 size={4.5}  sx={{flexGrow: 1,            // Allow this box to take remaining space
        display: 'flex' ,alignSelf :"flex-start",flexDirection:"column",}}>
          <Typography padding={1} sx={{color:"#4E5A6B",fontSize:"14px",fontWeight:"bold",            fontFamily: "Nunito Sans",
}}>Unit Details  </Typography>
      <UnitDetails />
      </Grid2>
      <Grid2 size={3.5}  sx={{flexGrow: 1,            // Allow this box to take remaining space
        display: 'flex' ,backgroundColor:"white",flexDirection:"column",   height: "65vh",alignItems: "center",justifyContent: "center"}} >
           <Typography padding={1} backgroundColor="white"   sx={{color:"#4E5A6B",fontSize:"14px",width:"88.5%",fontWeight:"bold",            fontFamily: "Nunito Sans",
    ...
    <div>
    <Box sx={{display:"flex",justifyContent:"space-between",backgroundColor:"white",width:"88.66vw",paddingBottom:"2px",             fontFamily: "Nunito Sans",
}}>
            <Box>
            ...
            <Box >
    <Button sx={{backgroundColor:"white",color:"black",border:"1px solid #d8d8d8",textTransform:"none",marginLeft:"20px",            fontFamily: "Nunito Sans",
}}>
      Cancel</Button>
      <Button sx={{backgroundColor:"rgb(80,120,225)",color:"white",marginLeft:"20px",textTransform:"none",            fontFamily: "Nunito Sans",
}}>Save Quotation</Button></Box>
        </Box>
    </div>
